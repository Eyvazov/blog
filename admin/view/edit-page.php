                        ...
                        <li>
                            ...
                            <div class="form-content">
                                <input type="text" id="page_title" name="page_title"
                                       value="<?= post('page_title') ? post('page_title') : $row['page_title'] ?>">
                            </div>
                        </li>
                        <li>
                            <label for="page_content">Səhifə Kontenti</label>
                            <div class="form-content">
                                <textarea name="page_content" class="editor" id="page_content" cols="30" rows="10"><?= post('page_content') ? post('page_content') : $row['page_content']?></textarea>
                            </div>
                        </li>
                    </ul>
                </div>
                <div tab-content>
                    <ul>
                        <li>
                            ...
                            <div class="form-content">
                                <input type="text" id="page_url" name="page_url"
                                       value="<?= post('page_url') ? post('page_url') : $row['page_url'] ?>"/>
                        ...
                        <li>
                            ...
                            <div class="form-content">
                                <input type="text" id="seo_title" name="page_seo[title]" value="<?= $seo['title']?>"/>
                            </div>
                        </li>
                        <li>
